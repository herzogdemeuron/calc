...
declare module '$env/static/private' {
	...
	export const PYTHONPATH1: string;
	export const REVITRON_DIRECTUS_TOKEN: string;
	export const SESSIONNAME: string;
	export const SiteInstallPoint: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		PUBLIC: string;
		PYTHONPATH1: string;
		REVITRON_DIRECTUS_TOKEN: string;
		SESSIONNAME: string;
		SiteInstallPoint: string;
		SystemDrive: string;
		SystemRoot: string;
		TEMP: string;
		TERM_PROGRAM: string;
